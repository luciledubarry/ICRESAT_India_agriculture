...
hrs_worked <- Employment_2014 |>
  select(SUR_MON_YR, VDS_ID, PRE_MEM_ID, OLD_MEM_ID, REL, GENDER, AGE, WORK_TYPE,
         WORK_DAYS, AVG_WORK_HRS, WAGES_NET_INC, INV_UNEMP_DAYS,
...
Pour ce deuxième cas, j'additionne les heures travaillées par moi des différents travaux employés par individu. 
