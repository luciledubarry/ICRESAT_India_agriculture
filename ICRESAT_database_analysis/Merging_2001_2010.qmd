...
#| message: false
#| warning: false
# Choisir l'année (2005, 2006 ou 2008)
annee <- 2008
...
Landholding <- Landholding |>
  select(VDS_ID, PLOT_NAME, PLOT_CODE, PLOT_AREA, CROP_AREA, IRRI_AREA, SOIL_TYPE, SOIL_TYPE_OT, SOIL_DEPTH, SOIL_FERT, SLOPE, SOIL_DEGR) |>
  rename(SUB_PLOT_CODE = PLOT_CODE) |>
  mutate(PLOT_CODE = substr(SUB_PLOT_CODE, 1, 1))
...
key_operations <- c(
  ...
  # FIELD CLEANING
  "FIELD CLEANING", "GRASS CLEANING", "SIDE CLEANING", "CLEANING AND WEEDING", "CLEANING WEED", 
  ...
  # PESTICIDE
  "PESTICIDE", "SPRAY", "FUNGICIDE", "INSECTICIDE", "HORMONE", "SULPHUR", "VITAMIN",
  
  # SOWING
  "SOWING", "SEED",
  
  # HERBICIDE
  "HERBICIDE", "WEEDICIDE", "HARBISIDE", "DEFOLIATION", "IPM AND IDM",
  ...
  # FERTILIZER
  "FERTILIZER", "FERTILIZING", "FERTIGATION", "FYM", "COMPOST", "NUTRIENT",
  
  # HARVESTING/THRESHING
  "HARVEST", "THRESHING", "THRASHING", "WINNOWING",
  ...
  # BUNDING
  "BUND", "WATER CHANNEL", "WATERING", "BASIN",
...
correspondances_oper <- tribble(
  ...
  "LEVELLING",                                    "LAND PREPARATION",
  "BUND",                                         "LAND PREPARATION",
  "WATER CHANNEL",                                "LAND PREPARATION",
  "WATERING",                                     "LAND PREPARATION",
  "BASIN",                                        "LAND PREPARATION",
  "DIGGING",                                      "LAND PREPARATION",
  "FILLING",                                      "LAND PREPARATION",
  "LINES",                                        "LAND PREPARATION",
  "LINING",                                       "LAND PREPARATION",
  "LINE MAKING",                                  "LAND PREPARATION",
  "PITTING",                                      "LAND PREPARATION",
  "TRENCHING",                                    "LAND PREPARATION",
  ...
  "UPROOTING",                                    "INTERCULTURE",
  "BINDING",                                      "INTERCULTURE",
  "GRASS CLEANING",                               "INTERCULTURE",
  "FIELD CLEANING",                               "INTERCULTURE",
  "SIDE CLEANING",                                "INTERCULTURE",
  "CLEANING WEED",                                "INTERCULTURE",
  "CLEANING AND WEEDING",                         "INTERCULTURE",
  "WEEDING AND CLEANING",                         "INTERCULTURE",
  "CLEANING",                                     "INTERCULTURE",
  ...
  "PRUNING",                                      "INTERCULTURE",
  "PINCHING",                                     "INTERCULTURE",
  "CUTTING",                                      "INTERCULTURE",
  "NIPPING",                                      "INTERCULTURE",
  "AIR LAYERING",                                 "INTERCULTURE",
  ...
  "FUMIGATION",                                   "PLANT PROTECTION",
  "SPRAY",                                        "PLANT PROTECTION",
  "FUNGICIDE",                                    "PLANT PROTECTION",
  "INSECTICIDE",                                  "PLANT PROTECTION",
  "HORMONE",                                      "PLANT PROTECTION",
  "HARMONE APPLICATION",                          "PLANT PROTECTION",
  "SULPHUR",                                      "PLANT PROTECTION",
  "VITAMIN",                                      "PLANT PROTECTION",
  "HERBICIDE",                                    "PLANT PROTECTION",
  "WEEDICIDE",                                    "PLANT PROTECTION",
  "HARBISIDE",                                    "PLANT PROTECTION",
  "HARBICIDE",                                    "PLANT PROTECTION",
  "DEFOLIATION",                                  "PLANT PROTECTION",
  "IPM AND IDM",                                  "PLANT PROTECTION",
  ...
  "THRASHING",                                    "HARVESTING & THRESHING",
...
```{r}
CultInput_LAB <- CultInput_LAB |>
  group_by(VDS_ID, PLOT_CODE, SUB_PLOT_CODE, CROP_AREA, SEASON, LAB_TYPE, DT_OPER, OPERATION, .keep = "all") |>
...
CultInput_MAT <- CultInput_MAT |>
  ...
  mutate(row_id = row_number()) |>
  filter(row_id <= 6) |>  # Limiter à 6 outils max
  ungroup() |>
  pivot_wider(
...
```{r Correspondance couple VDS_ID / SUB_PLOT_CODE / SEASON / CROP_AREA entre les bases}
...
```{r Correspondance Cultivation -> Household_info}
...
write.csv(
  Cultivation_wide,
  file = file.path(folder_path, "Cultivation_wide.csv"),
  row.names = FALSE
)
...
saveRDS(
  Cultivation_wide,
  file = file.path(folder_path, "Cultivation_wide.rds"),
)
```
