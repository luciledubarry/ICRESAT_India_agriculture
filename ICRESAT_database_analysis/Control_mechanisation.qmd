...
hacre_oper |>
  ...
  labs(
    title = "Non-mechanized harvesting: Family female labor and plot size, by caste",
    x = "Plot size (in acres)",
    y = "Family female labor hours for non-mechanized harvesting in the season",
    color = "Caste"
  ) +
  theme_minimal() +
  theme(
...
hacre_oper |>
  ...
  labs(
    ...
    x = "Plot size (in acres)",
    y = "Family female labor hours for hand weeding in the season",
    color = "Caste"
  ) +
  theme_minimal() +
  theme(
...
hacre_oper |>
  ...
  coord_cartesian(xlim = c(0, 2), ylim = c(0, 80)) +
  labs(
    title = "Non-mechanized transplanting: Family female labor and plot size, by caste",
    x = "Plot size (in acres)",
    y = "Family female labor hours for non-mechanized transplanting in the season",
    color = "Caste"
  ) +
  theme_minimal() +
  theme(
...
hacre_all_labor |>
  filter(OPERATION == "HARVESTING & THRESHING") |>
  ggplot(aes(x = AREA_CROP, y = ALL_WORK, color = CASTE_GROUP)) +
  geom_point(alpha = 0.3) +
  geom_smooth(method = "loess", se = FALSE, linewidth = 1.2) +
    coord_cartesian(xlim = c(0, 3), ylim = c(0, 250)) +
  labs(
    title = "Non-mechanized harvesting: Total labor and plot size, by caste",
    x = "Plot size (in acres)",
    y = "Total labor hours for non-mechanized harvesting in the season",
    color = "Caste"
  ) +
  theme_minimal() +
  theme(
...
hacre_all_labor |>
  ...
  labs(
    title = "Hand weeding: Total labor and plot size, by caste",
    x = "Plot size (in acres)",
    y = "Total labor hours for hand weeding in the season",
    color = "Caste"
  ) +
  theme_minimal() +
  theme(
...
hacre_all_labor |>
  ...
  geom_smooth(method = "loess", se = FALSE, linewidth = 1.2) +
    coord_cartesian(xlim = c(0, 3), ylim = c(0, 250)) +
  labs(
    title = "Non-mechanized transplanting: Total labor and plot size, by caste",
    x = "Plot size (in acres)",
    y = "Total labor hours for non-mechanized transplanting in the season",
    color = "Caste"
  ) +
  theme_minimal() +
  theme(
...
hacre_all_labor |>
  ...
  labs(
    title = "Non-mechanized tilling: Total labor and plot size, by caste",
    x = "Plot size (in acres)",
    y = "Total labor hours for non-mechanized tilling in the season",
    color = "Caste"
  ) +
  theme_minimal() +
  theme(
