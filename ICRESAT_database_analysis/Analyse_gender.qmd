...
### Salaire horaire par genre et type d'emploi

On regarde le salaire horaire par type d'emploi (familial ou salarié) et par genre. 
Le but est de notamment regarder si le travail féminin familial est effectivement moins coûteux que le travail féminin employé. 


AJOUTER LA VARIABLE WAGE! à Cultivation_cult_distinctes

Calcul du salaire horaire
wage_gender <- Cultivation_expand |>
  mutate(WAGE_PER_HR = WAGE / WORK_HR)
wage_gender$WAGE_PER_HR <- round(wage_gender$WAGE_PER_HR, 2) 
