...
####### Brouillon: Somme des champs faisant du riz par ménage

A VOIR SI GARDER: La partie suivante calcule le temps de travail, la superficie et la producivité du travail en se basant sur la somme des dechamps faisant du riz en Kharif par ménage. 


```{r}
# Superficie totale par ménage (PADDY et KHARIF uniquement)
hh_area <- Cultivation_expand |>
  filter(!is.na(CASTE_GROUP), CROP == "PADDY", SEASON == "KHARIF") |>
