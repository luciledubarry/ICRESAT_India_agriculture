...
*Enregistrer PlotList*

```{r}
# Définir le chemin du dossier
folder_path <- here("Base de données générées", "PlotList")
...
write.csv(
  PlotList,
  file = file.path(folder_path, "PlotList.csv"),
  row.names = FALSE
)
...
saveRDS(
  PlotList,
  file = file.path(folder_path, "PlotList.rds"),
)
```
...
```{r}
CultInput <- CultInput |>
  select(SUR_YR, REGION, VDS_ID, PLOT_NAME, PLOT_CODE, CROP_AREA, IRRI_AREA, SEASON, SUR_MON_YR, DT_OPER, OPERATION, LAB_TYPE, WORK_HR, WAGE, NAME_MAT, TYPE_MAT, QTY_MAT, UNIT_MAT, VAL_MAT, RATE_MAT, SOURCE_MAT) |>
