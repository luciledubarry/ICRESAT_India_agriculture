...
Table_chemicals <- Cultivation_expand |>
  select(VDS_ID, SEASON, CROP, PLOT_CODE, SUB_PLOT_CODE, CASTE_GROUP, AREA_HH, PLOT_AREA, CROP_AREA, contains(c("TYPE_MAT", "UNIT_MAT", "QTY_MAT")))
...
Table_chemicals <- Table_chemicals |>
  filter(TYPE_MAT %in% c("PESTICIDE/FUNGICIDE", "FERTILIZER", "WEEDICIDE", "OTHERS")) |>
  group_by(VDS_ID, SEASON, CROP, PLOT_CODE, SUB_PLOT_CODE, PLOT_AREA, CROP_AREA, TYPE_MAT, UNIT_MAT) |>
