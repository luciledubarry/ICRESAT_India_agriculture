...
Cultivation_long <- Cultivation_long |>
  select(
    SUR_YR, SEASON, SUR_MON_YR, MONTH, VDS_ID, CASTE, CASTE_GROUP, PLOT_CODE, SUB_PLOT_CODE, CROP, AREA_HH, PLOT_AREA, CROP_AREA, IRRI_AREA, IRRIGATION, DT_OPER, OPERATION, mechanized, REGION, STATE, VILLAGE, VILLAGE_CROP, everything()  
...
base_to_join <- Cultivation_long |>
  select(
    ...
    DT_OPER, SUR_MON_YR, mechanized, MONTH, GENDER, EMPLOYMENT, cols_expand
  )
...
group_vars <- c("SUR_YR", "VDS_ID", "CASTE_GROUP", "SEASON", "CROP", "PLOT_CODE", 
...
write.csv(
  Table_labor_plot,
  file = file.path(folder_path, "Table_labor_plot.csv"),
  row.names = FALSE
)
saveRDS(
  Table_labor_plot,
  file = file.path(folder_path, "Table_labor_plot.rds"),
)

# Enregistrer Table_labor_hh
write.csv(
  Table_labor_hh,
  file = file.path(folder_path, "Table_labor_hh.csv"),
  row.names = FALSE
)
saveRDS(
  Table_labor_hh,
  file = file.path(folder_path, "Table_labor_hh.rds"),
)
```
