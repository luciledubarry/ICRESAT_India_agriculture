...
paddy_area <- Cultivation_long |>
  distinct(VDS_ID, PLOT_AREA, CROP_AREA, PLOT_CODE, SUB_PLOT_CODE, CROP, SEASON) |>
  group_by(VDS_ID, SEASON) |>
  mutate(AREA_HH = sum(CROP_AREA, na.rm = TRUE)) |>
  ungroup() |>
  filter(CROP == "PADDY") |>
  group_by(VDS_ID, AREA_HH, SEASON) |>
...
group_vars <- c("SUR_YR", "VDS_ID", "CASTE_GROUP", "SEASON", "CROP", "PLOT_AREA",
                ...
                "SOIL_FERT", "SOIL_DEGR", "SLOPE", "hand_weeding")
