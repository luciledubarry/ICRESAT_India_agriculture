...
Je construis pour les régressions des tables à plusieurs niveaux : du ménage (une ligne par ménage), du champ (subplot) et de l'opération.
...
# Sélectionner les variables d'intérêt
  select(VDS_ID, CASTE_GROUP, PLOT_CODE, SUB_PLOT_CODE, AREA_HH, PLOT_AREA, AREA_CROP, CROP, SEASON, OPERATION, LAB_TYPE, WORK_HR, IRRIGATION, MACHINERY, VAR_TYPE, with_paddy, paddy_prct, REGION, STATE, VILLAGE, VILLAGE_CROP) |>
...
non_area_hh <- anti_join(Cultivation_paddy, plotlist_area_hh, by = c("VDS_ID", "AREA_HH"))
