...
PlotList_2014 <- PlotList_2014 |>
  filter(!is.na(VDS_ID)) |>
  select(-CROP_3, - CROP_4, -OW_STAT, -RENT_REC_PAID, -REMARKS, -HH_NO)
```
...
# Lorsque la superficie du subplot est manquante (CROP_AREA = n/a), je considère alors la superficie du plot (PLOT_AREA)
  mutate(CROP_AREA = if_else(is.na(CROP_AREA), PLOT_AREA, CROP_AREA)) |>

# De la même manière, si SUB_PLOT_CODE n'est pas indiqué, je considère l'identifiant du plot (PLOT_CODE)
