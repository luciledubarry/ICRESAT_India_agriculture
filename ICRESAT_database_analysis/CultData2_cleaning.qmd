...
plots_by_household <- Cultivation_cult_distinctes |>
  distinct(VDS_ID, PLOT_CODE, SUB_PLOT_CODE, SEASON, CROP, CROP_ID, AREA_HH, PLOT_AREA, AREA_CROP, IRRI_CROP, VAR_TYPE, VAR_NAME, MULTI_CROPING, REGION, STATE, VILLAGE, VILLAGE_CROP, with_paddy, paddy_prct)
...
base_to_join <- Cultivation_cult_distinctes |>
  select(
    ...
    FERTILIZER, HERBICIDE, LAB_TYPE, WORK_HR, 
