...
### Comptages des ménages/champs par saison

On compte les ménages et champs présents par saison. 
Attention, les champs et ménages sont comptabilisés deux fois (une fois par saison)

```{r}
Cultivation_expand |>
  group_by(SEASON) |>
  summarise(
    `Nombre de ménages` = n_distinct(VDS_ID, SEASON),
