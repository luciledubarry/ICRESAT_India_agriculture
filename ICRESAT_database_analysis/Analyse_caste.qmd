---
title: "Partie 3 : Analyse par caste de la base Cultivation 2014"
format: html
editor: source
---
...
## Comptage des champs/ménages

### Total par saison

Attention, les champs sont comptés par saison donc deux fois (Kharif et Rabi). 
Les ménages sont comptabilisés une seule fois (sans considérer la saison). 
...
```
Environ 1,000 champs enregistrés en Kharif ne le sont plus en Rabi.
Cela concerne certainement des champs en jachère qui n'ont aucune activité agricole en Rabi pour 2014. Je les ajoute manuellement pour pouvoir considérer ces champs dans l'analyse. 
...
total_champs_kharif <- n_distinct(crop_choice_kharif$VDS_ID, crop_choice_kharif$PLOT_CODE, crop_choice_kharif$CROP)
...
VERIF : Pourquoi il y a 1300 champs de riz en Kharif, mais seulement environ 500 champs retants en Rabi (les jachères sont inclus normalement dans CROP) ?
